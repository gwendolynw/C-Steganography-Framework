...
main (int argc, char **argv)
{
  ...
  //TO-DO:  ADD SOME KIND OF STRUCT: coefficient{ int row; int column; int value;}.
  // MAKE BUFFER: create usable coefficient buffer by going through every block returned by framework and selecting modes 1-4.  with struct metadata, will be able to go back and edit changed coefficients
